...
export const testIds = {
  ...
  auth: {
    ...
    devQuickLogin: (username: string) => `dev-quick-login-${username}`,
  },
  ...
  instituteExaminations: {
    ...
    skeleton: 'examinations-skeleton',
    emptyState: 'examinations-empty-state',
    emptyCreateBtn: 'examinations-empty-create-btn',
    row: (id: string) => `exam-row-${id}`,
    rowLink: (id: string) => `exam-row-${id}-link`,
    rowStatus: (id: string) => `exam-row-${id}-status`,
    ...
    detailSkeleton: 'exam-detail-skeleton',
    detailStatus: 'exam-detail-status',
    ...
    unarchiveBtn: 'exam-unarchive-btn',
    // Datesheet
    datesheet: 'exam-datesheet',
    datesheetSkeleton: 'exam-datesheet-skeleton',
    datesheetEmpty: 'exam-datesheet-empty',
    datesheetDownloadBtn: 'exam-datesheet-download-btn',
    editDatesheetBtn: 'exam-edit-datesheet-btn',
    designerDialogShell: 'exam-designer-dialog-shell',
    designerBackBtn: 'exam-designer-back-btn',
    addScheduleBtn: 'exam-add-schedule-btn',
    scheduleRow: (id: string) => `exam-schedule-row-${id}`,
    scheduleEditBtn: (id: string) => `exam-schedule-row-${id}-edit-btn`,
    scheduleDeleteBtn: (id: string) => `exam-schedule-row-${id}-delete-btn`,
    ...
    scheduleInvigilatorSelect: 'exam-schedule-invigilator-select',
    scheduleMaxMarksInput: 'exam-schedule-max-marks-input',
    schedulePassMarksInput: 'exam-schedule-pass-marks-input',
    scheduleDateInput: 'exam-schedule-date-input',
    scheduleStartInput: 'exam-schedule-start-input',
    scheduleEndInput: 'exam-schedule-end-input',
    scheduleRoomInput: 'exam-schedule-room-input',
    ...
    designer: 'exam-datesheet-designer',
    // Optional class filter; "All classes" by default. Replaces the old mandatory picker.
    designerClassFilter: 'exam-designer-class-filter',
    designerMatrix: 'exam-designer-matrix',
    // Per-class group header + its collapse toggle (rows = sections of that class).
    designerClassGroup: (standardId: string) => `exam-designer-class-group-${standardId}`,
    designerGroupToggle: (standardId: string) => `exam-designer-group-toggle-${standardId}`,
    // Cell keyed by section + ISO date so each (section,date) is uniquely addressable.
    designerCell: (sectionId: string, date: string) => `exam-designer-cell-${sectionId}-${date}`,
    // Apply-to-all is per class now (subjects are class-specific), so keyed by both.
    designerDateAddAll: (standardId: string, date: string) =>
      `exam-designer-date-add-all-${standardId}-${date}`,
    designerAddDateInput: 'exam-designer-add-date-input',
    designerAddDateBtn: 'exam-designer-add-date-btn',
    designerDateDelete: (date: string) => `exam-designer-date-delete-${date}`,
    designerDateGapAdd: (date: string) => `exam-designer-gap-add-${date}`,
    designerDeleteDateDialog: 'exam-designer-delete-date-dialog',
    designerDeleteDateConfirm: 'exam-designer-delete-date-confirm',
    designerDeleteDateCancel: 'exam-designer-delete-date-cancel',
    designerDialog: 'exam-designer-dialog',
    designerSubjectSelect: 'exam-designer-subject-select',
    designerShiftSelect: 'exam-designer-shift-select',
    designerRoomInput: 'exam-designer-room-input',
    designerInvigilatorSelect: 'exam-designer-invigilator-select',
    designerStartInput: 'exam-designer-start-input',
    designerEndInput: 'exam-designer-end-input',
    designerApplyAll: 'exam-designer-apply-all',
    designerAddPaperBtn: 'exam-designer-add-paper-btn',
    designerSubmitBtn: 'exam-designer-submit-btn',
    designerPaperRow: (id: string) => `exam-designer-paper-row-${id}`,
    designerPaperRemoveBtn: (id: string) => `exam-designer-paper-remove-${id}-btn`,
    // Marks grid
    marksPage: 'exam-marks-page',
    marksGrid: 'exam-marks-grid',
    marksSkeleton: 'exam-marks-skeleton',
    ...
    resultsSkeleton: 'exam-results-skeleton',
    resultsEmpty: 'exam-results-empty',
    resultsSectionSelect: 'exam-results-section-select',
    // Link from the exam detail header to the dedicated results page (published exams only).
    resultsLink: 'exam-results-link',
    // Grading schemes
    gradingPage: 'grading-page',
    gradingTitle: 'grading-title',
    gradingCreateBtn: 'grading-create-btn',
    gradingSkeleton: 'grading-skeleton',
    gradingEmpty: 'grading-empty',
    gradingEmptyCreateBtn: 'grading-empty-create-btn',
    ...
    reportCardsSkeleton: 'report-cards-skeleton',
    reportCardsEmpty: 'report-cards-empty',
    reportCardsEmptyCreateBtn: 'report-cards-empty-create-btn',
    reportCardRow: (id: string) => `report-card-row-${id}`,
    reportCardRowStatus: (id: string) => `report-card-row-${id}-status`,
    ...
    myReportCardsSkeleton: 'my-report-cards-skeleton',
