...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const NAV_REGISTRY: Record<string, NavRegistryEntry> = {
    ...
    [NAV_SLUGS.examinations]: {
      href: '/examinations',
      icon: GraduationCap,
      label: t('examinations'),
      ability: { action: 'read', subject: 'Exam' },
    },
    [NAV_SLUGS.reportCards]: {
      href: '/examinations/report-cards',
      icon: FileText,
      label: t('reportCards'),
      ability: { action: 'read', subject: 'ReportCard' },
    },
    [NAV_SLUGS.gradingSchemes]: {
      href: '/examinations/grading-schemes',
      icon: Award,
      label: t('gradingSchemes'),
      ability: { action: 'read', subject: 'GradingScheme' },
    },
    [NAV_SLUGS.myReportCards]: {
      href: '/examinations/report-cards/my',
      icon: FileText,
      label: t('myReportCards'),
      ability: { action: 'read', subject: 'ReportCard' },
    },
    [NAV_SLUGS.tc]: {
    ...
    navGroups: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: t('examinations'), href: '/examinations', icon: GraduationCap },
          { title: t('reportCards'), href: '/examinations/report-cards', icon: FileText },
          { title: t('gradingSchemes'), href: '/examinations/grading-schemes', icon: Award },
          { title: t('myReportCards'), href: '/examinations/report-cards/my', icon: FileText },
          ...
          { title: t('holidays'), href: '/holiday', icon: CalendarDays },
