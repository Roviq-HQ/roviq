...
export class HolidayDrizzleRepository extends HolidayRepository {
  ...
  async findById(id: string): Promise<HolidayRecord | null> {
    ...
    return withTenant(this.db, mkInstituteCtx(tenantId, 'repository:holiday'), async (tx) => {
  ...
  async softDelete(id: string): Promise<void> {
    const tenantId = this.getTenantId();
    await withTenant(this.db, mkInstituteCtx(tenantId, 'repository:holiday'), async (tx) => {
