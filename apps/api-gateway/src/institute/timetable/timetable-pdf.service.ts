...
/** Bottom band kept clear for the footer — drawing below the margin auto-adds a blank page. */
  ...
  private render(opts: RenderOptions): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      ...
      for (const period of periods) {
        ...
        // Page break: redraw the header on the new page. Rows stop above the
        // footer band so neither content nor footer spills onto a blank page.
        if (y + rowHeight > PAGE.height - PAGE.margin - FOOTER_RESERVE) {
      ...
      doc
        ...
        .text(
          ...
          PAGE.margin,
          PAGE.height - PAGE.margin - FOOTER_RESERVE + 4,
